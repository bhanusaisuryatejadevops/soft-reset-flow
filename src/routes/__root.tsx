...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "reset — quiet tools for rebuilding your routines slowly" },
      { name: "description", content: "for the days you feel mentally exhausted. emotional productivity tools, calm journaling, and gentle reset rituals." },
      { property: "og:title", content: "reset — quiet productivity for tired minds" },
